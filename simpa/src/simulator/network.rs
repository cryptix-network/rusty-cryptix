...
use cryptix_consensus::config::Config;
...
use cryptix_database::{create_permanent_db, create_temp_db};
use cryptix_utils::fd_budget;
use cryptix_utils::sim::Simulation;

type ConsensusWrapper = (Arc<Consensus>, Vec<JoinHandle<()>>, DbLifetime);

pub struct CryptixNetworkSimulator {
