...
use cryptix_consensus_core::hashing::sighash::SigHashReusedValues;
...
opcode_list! {
    ...
    opcode OpIf<0x63, 1>(self, vm) {
        ...
        if vm.is_executing() {
            ...
            // the similar flow of go-cryptixd
...
mod test {
    ...
    use cryptix_consensus_core::constants::{SOMPI_PER_CRYPTIX, TX_VERSION};
    ...
    mod kip10 {
        ...
        use cryptix_consensus_core::tx::MutableTransaction;
