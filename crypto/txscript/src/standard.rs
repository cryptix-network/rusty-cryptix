...
use cryptix_consensus_core::tx::{ScriptPublicKey, ScriptVec};
    ...
    fn test_extract_address_and_encode_script() {
        ...
        let tests = vec![
            ...
            Test {
                ...
                expected_address: Ok("cryptixtest:qxaqrlzlf6wes72en3568khahq66wf27tuhfxn5nytkd8tcep2c0vrse6gdmpks"
                    .try_into()
                    .unwrap()),
            },
            Test {
