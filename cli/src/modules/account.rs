                    ...
                    ctx.term().help(
                        &[
                            ...
                            (
                                ...
                                "Import accounts 12 word mnemonic used by legacy applications (KDX and cryptix-network web wallet)",
                            ),
                            (
                ...
                match import_kind.as_ref() {
                    "legacy-data" => {
                        ...
                        if exists_legacy_v0_keydata().await? {
                            ...
                            return Err("'cryptix-network' web wallet storage not found at this domain name".into());
                        } else {
                    ...
                    "mnemonic" => {
                        if argv.is_empty() {
                            ...
                            tprintln!(ctx, "please use 'legacy' for 12-word KDX and cryptix-network web wallet mnemonics\r\n");
                            return Ok(());
                        }
    ...
    async fn display_help(self: Arc<Self>, ctx: Arc<CryptixCli>, _argv: Vec<String>) -> Result<()> {
        ctx.term().help(
            &[
                ...
                (KDX and cryptix-network web wallet). Use 'account import' for additional help.",
                ),
