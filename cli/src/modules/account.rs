use cryptix_wallet_core::account::BIP32_ACCOUNT_KIND;
use cryptix_wallet_core::account::LEGACY_ACCOUNT_KIND;
use cryptix_wallet_core::account::MULTISIG_ACCOUNT_KIND;
        ...
        match action.as_str() {
            ...
            "import" => {
                if argv.is_empty() {
                    ...
                    ctx.term().help(
                        &[
                            ("account import legacy-data", "Import KDX keydata file or cryptixnet web wallet data on the same domain"),
                            (
                            ...
                            (
                                ...
                                "Import accounts 12 word mnemonic used by legacy applications (KDX and cryptixnet web wallet)",
                            ),
                            (
                ...
                match import_kind.as_ref() {
                    "legacy-data" => {
                        ...
                        if exists_legacy_v0_keydata().await? {
                            ...
                            return Err("'cryptixnet' web wallet storage not found at this domain name".into());
                        } else {
                    ...
                    "mnemonic" => {
                        if argv.is_empty() {
                            ...
                            tprintln!(ctx, "please use 'legacy' for 12-word KDX and cryptixnet web wallet mnemonics\r\n");
                            return Ok(());
                        }
    ...
    async fn display_help(self: Arc<Self>, ctx: Arc<CryptixCli>, _argv: Vec<String>) -> Result<()> {
        ctx.term().help(
            &[
                ...
                (KDX and cryptixnet web wallet). Use 'account import' for additional help.",
                ),
