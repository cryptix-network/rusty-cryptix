...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] cryptix_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] cryptix_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] cryptix_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] cryptix_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(cryptix_metrics_core::error::Error),

    #[error(transparent)]
    CryptixWalletKeys(#[from] cryptix_wallet_keys::error::Error),

    #[error(transparent)]
    PskbLockScriptSigError(#[from] cryptix_wallet_pskt::error::Error),
