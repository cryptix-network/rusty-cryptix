...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            CryptixdMessagePayloadType::Addresses,
            CryptixdMessagePayloadType::Block,
            CryptixdMessagePayloadType::Transaction,
            CryptixdMessagePayloadType::BlockLocator,
            CryptixdMessagePayloadType::RequestAddresses,
            CryptixdMessagePayloadType::RequestRelayBlocks,
            CryptixdMessagePayloadType::RequestTransactions,
            CryptixdMessagePayloadType::IbdBlock,
            CryptixdMessagePayloadType::InvRelayBlock,
            CryptixdMessagePayloadType::InvTransactions,
            CryptixdMessagePayloadType::Ping,
            CryptixdMessagePayloadType::Pong,
            // CryptixdMessagePayloadType::Verack,
            // CryptixdMessagePayloadType::Version,
            // CryptixdMessagePayloadType::Ready,
            CryptixdMessagePayloadType::TransactionNotFound,
            CryptixdMessagePayloadType::Reject,
            CryptixdMessagePayloadType::PruningPointUtxoSetChunk,
            CryptixdMessagePayloadType::RequestIbdBlocks,
            ...
            CryptixdMessagePayloadType::RequestNextHeaders,
            CryptixdMessagePayloadType::DoneHeaders,
            CryptixdMessagePayloadType::RequestPruningPointUtxoSet,
            CryptixdMessagePayloadType::RequestHeaders,
            CryptixdMessagePayloadType::RequestBlockLocator,
            CryptixdMessagePayloadType::PruningPoints,
            CryptixdMessagePayloadType::RequestPruningPointProof,
    ...
    async fn call(&self, msg: pb::CryptixdMessage) -> bool {
        // echo
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate cryptix P2P handshaking
        //
...
mod tests {
    ...
    async fn test_handshake() {
        cryptix_core::log::try_init_logger("debug");
