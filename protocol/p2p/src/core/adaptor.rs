...
/// The main object to create for managing a fully-fledged Cryptix P2P peer
pub struct Adaptor {
    //
...
impl Adaptor {
    ...
    /// Creates a P2P adaptor with only client-side support. Typical Cryptix nodes should use `Adaptor::bidirectional`
