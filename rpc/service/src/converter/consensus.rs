...
use cryptix_consensus_notify::notification::{self as consensus_notify, Notification as ConsensusNotification};
use cryptix_consensusmanager::{ConsensusManager, ConsensusProxy};
use cryptix_math::Uint256;
use cryptix_mining::model::{owner_txs::OwnerTransactions, TransactionIdSet};
use cryptix_notify::converter::Converter;
...
use cryptix_txscript::{extract_script_pub_key_address, script_class::ScriptClass};
...
impl ConsensusConverter {
    ...
    ///
    /// _GO-CRYPTIXD: PopulateBlockWithVerboseData_
    ...
    ///
    /// _GO-CRYPTIXD: PopulateTransactionWithVerboseData
