...
use cryptix_rpc_core::{FromRpcHex, RpcError, RpcHash, RpcResult, RpcScriptVec, ToRpcHex};
use std::str::FromStr;
...
from!(item: &cryptix_rpc_core::RpcTransaction, protowire::RpcTransaction, {
    Self {
...
from!(item: &cryptix_rpc_core::RpcTransactionInput, protowire::RpcTransactionInput, {
    Self {
...
from!(item: &cryptix_rpc_core::RpcTransactionOutput, protowire::RpcTransactionOutput, {
    Self {
        amount: item.value,
...
from!(item: &cryptix_rpc_core::RpcTransactionOutpoint, protowire::RpcOutpoint, {
    Self { transaction_id: item.transaction_id.to_string(), index: item.index }
});

from!(item: &cryptix_rpc_core::RpcUtxoEntry, protowire::RpcUtxoEntry, {
    Self {
        amount: item.amount,
        script_public_key: Some((&item.script_public_key).into()),
...
from!(item: &cryptix_rpc_core::RpcScriptPublicKey, protowire::RpcScriptPublicKey, {
    Self { version: item.version().into(), script_public_key: item.script().to_rpc_hex() }
});

from!(item: &cryptix_rpc_core::RpcTransactionVerboseData, protowire::RpcTransactionVerboseData, {
    Self {
...
from!(&cryptix_rpc_core::RpcTransactionInputVerboseData, protowire::RpcTransactionInputVerboseData);

from!(item: &cryptix_rpc_core::RpcTransactionOutputVerboseData, protowire::RpcTransactionOutputVerboseData, {
    Self {
...
from!(item: &cryptix_rpc_core::RpcAcceptedTransactionIds, protowire::RpcAcceptedTransactionIds, {
    Self {
...
from!(item: &cryptix_rpc_core::RpcUtxosByAddressesEntry, protowire::RpcUtxosByAddressesEntry, {
    Self {
...
try_from!(item: &protowire::RpcTransaction, cryptix_rpc_core::RpcTransaction, {
    Self {
        version: item.version.try_into()?,
        inputs: item
            .inputs
            .iter()
            .map(cryptix_rpc_core::RpcTransactionInput::try_from)
            .collect::<RpcResult<Vec<cryptix_rpc_core::RpcTransactionInput>>>()?,
        outputs: item
            .outputs
            .iter()
            .map(cryptix_rpc_core::RpcTransactionOutput::try_from)
            .collect::<RpcResult<Vec<cryptix_rpc_core::RpcTransactionOutput>>>()?,
        lock_time: item.lock_time,
        subnetwork_id: cryptix_rpc_core::RpcSubnetworkId::from_str(&item.subnetwork_id)?,
        gas: item.gas,
...
try_from!(item: &protowire::RpcTransactionInput, cryptix_rpc_core::RpcTransactionInput, {
    Self {
        ...
        verbose_data: item.verbose_data.as_ref().map(cryptix_rpc_core::RpcTransactionInputVerboseData::try_from).transpose()?,
    }
});

try_from!(item: &protowire::RpcTransactionOutput, cryptix_rpc_core::RpcTransactionOutput, {
    Self {
        value: item.amount,
...
try_from!(item: &protowire::RpcOutpoint, cryptix_rpc_core::RpcTransactionOutpoint, {
    Self { transaction_id: RpcHash::from_str(&item.transaction_id)?, index: item.index }
});

try_from!(item: &protowire::RpcUtxoEntry, cryptix_rpc_core::RpcUtxoEntry, {
    Self {
        amount: item.amount,
        script_public_key: item
            .script_public_key
...
try_from!(item: &protowire::RpcScriptPublicKey, cryptix_rpc_core::RpcScriptPublicKey, {
    Self::new(u16::try_from(item.version)?, RpcScriptVec::from_rpc_hex(item.script_public_key.as_str())?)
});

try_from!(item: &protowire::RpcTransactionVerboseData, cryptix_rpc_core::RpcTransactionVerboseData, {
    Self {
...
try_from!(&protowire::RpcTransactionInputVerboseData, cryptix_rpc_core::RpcTransactionInputVerboseData);

try_from!(item: &protowire::RpcTransactionOutputVerboseData, cryptix_rpc_core::RpcTransactionOutputVerboseData, {
    Self {
...
try_from!(item: &protowire::RpcAcceptedTransactionIds, cryptix_rpc_core::RpcAcceptedTransactionIds, {
    Self {
...
try_from!(item: &protowire::RpcUtxosByAddressesEntry, cryptix_rpc_core::RpcUtxosByAddressesEntry, {
