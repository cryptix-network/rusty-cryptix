use crate::{
    error::{Error, Result},
    resolver::{CryptixdResponseReceiver, CryptixdResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: CryptixdResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: CryptixdPayloadOps, request: &CryptixdRequest) -> CryptixdResponseReceiver {
