//!
//! # Standardized JSON serialization and deserialization of Cryptix transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! Cryptix transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSKT` in the [`cryptix_wallet_pskt`](https://docs.rs/cryptix_wallet_pskt)
//! crate.
//!
