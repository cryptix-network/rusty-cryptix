...
use cryptix_consensus_core::network::NetworkTypeT;
use cryptix_consensus_core::subnets::{self, SubnetworkId};
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<cryptix_addresses::AddressArrayT> {
