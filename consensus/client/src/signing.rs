...
use cryptix_consensus_core::hashing::sighash_type::{SigHashType, SIG_HASH_ALL};
use cryptix_consensus_core::subnets::SUBNETWORK_ID_NATIVE;
use cryptix_consensus_core::tx::{TransactionOutpoint, TransactionOutput, VerifiableTransaction};
// use cryptix_hashes::{Hash, Hasher, HasherBase, TransactionSigningHash};
...
use cryptix_consensus_core::hashing::HasherExtensions;
