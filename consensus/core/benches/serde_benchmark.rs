...
use cryptix_consensus_core::subnets::SUBNETWORK_ID_COINBASE;
...
fn serialize_benchmark(c: &mut Criterion) {
    ...
    let transaction = Transaction::new(
        ...
        vec![
            TransactionOutput { value: 300, script_public_key: script_public_key.clone(), payload: vec![] },
            TransactionOutput { value: 300, script_public_key, payload: vec![] },
        ],
        0,
