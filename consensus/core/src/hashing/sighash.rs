...
mod tests {
    ...
    fn test_signature_hash() {
        // TODO: Copy all sighash tests from go cryptixd.
        ...
        let native_tx = Transaction::new(
            ...
            vec![
                TransactionOutput { value: 300, script_public_key: ScriptPublicKey::new(0, script_pub_key_2.clone()), payload: vec![] },
                TransactionOutput { value: 300, script_public_key: ScriptPublicKey::new(0, script_pub_key_1.clone()), payload: vec![] },
            ],
            1615462089000,
