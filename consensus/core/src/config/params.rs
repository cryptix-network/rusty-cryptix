...
pub struct Params {
    ...
    /// The parameter for scaling inverse CPAY value to mass units (unpublished KIP-0009)
...
impl Params {
    ...
    /// Based on the analysis at <https://github.com/cryptix-network/docs/blob/main/Reference/prunality/Prunality.pdf>
...
pub const MAINNET_PARAMS: Params = Params {
    ...
    payload_hf_activation_daa_score: 2_000,
