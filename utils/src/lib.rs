...
//! # Cryptix Utilities
//!
//! General purpose utilities and various type extensions used across the Rusty Cryptix codebase.
//!
...
/// struct MyStructVec {
///     #[serde(with = "cryptix_utils::serde_bytes")]
///     v: Vec<u8>,
/// }
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "cryptix_utils::serde_bytes_fixed")]
///     v: [u8; 20],
/// }
...
///     }
/// }
/// impl cryptix_utils::hex::FromHex for MyStruct {
...
///     }
/// }
/// cryptix_utils::serde_impl_ser_fixed_bytes_ref!(MyStruct, 20);
/// cryptix_utils::serde_impl_deser_fixed_bytes_ref!(MyStruct, 20);
///
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "cryptix_utils::serde_bytes_fixed_ref")]
///     v: MyStruct,
/// }
///
