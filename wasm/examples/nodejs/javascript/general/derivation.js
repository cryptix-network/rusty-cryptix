...
(async () => {
    ...
    let pubkey1 = xPrv.derivePath("m/44'/555555'/0'/0/1").toXPub().toPublicKey();
    console.log("publickey", pubkey1.toString())
    console.log("address", pubkey1.toAddress(NetworkType.Mainnet));

    // create receive wallet
    let receiveWalletXPub = xPrv.derivePath("m/44'/555555'/0'/0").toXPub();
    ...
    let changeWalletXPub = xPrv.derivePath("m/44'/555555'/0'/1").toXPub();
    ...
    let privateKey = xPrv.derivePath("m/44'/555555'/0'/0/1").toPrivateKey();
