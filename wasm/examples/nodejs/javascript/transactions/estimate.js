...
(async () => {
    ...
    console.info(`Full cryptix address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Cryptix
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : cryptixToSompi(0.2)}],
            priorityFee: cryptixToSompi(0.0001),
