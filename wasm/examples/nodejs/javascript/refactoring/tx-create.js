...
const cryptix = require('../cryptix/cryptix_wasm');
...
cryptix.init_console_panic_hook();
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"cryptix:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "cryptixtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("cryptixtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new cryptix.TransactionOutput(300n, new cryptix.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new cryptix.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
