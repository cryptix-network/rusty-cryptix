...
/// This class accepts the master Cryptix XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in Cryptix master private keys use `kprv` prefix.
///
