//!
//! PSKT is a crate for working with Partially Signed Cryptix Transactions (PSKTs).
...
//! multiple `PSKT` instances allowing for exchange of Cryptix sweep transactions.
//!
