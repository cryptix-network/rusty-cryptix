//!
//! Legacy (KDX, cryptixnet.io Web Wallet) account implementation
//!

use crate::account::{AsLegacyAccount, Inner};
use crate::derivation::{AddressDerivationManager, AddressDerivationManagerTrait};
use crate::imports::*;
use cryptix_bip32::{ExtendedPrivateKey, Prefix, SecretKey};

const CACHE_ADDRESS_OFFSET: u32 = 2048;

pub const LEGACY_ACCOUNT_KIND: &str = "cryptix-legacy-standard";
...
impl Factory for Ctor {
    ...
    fn description(&self) -> String {
        "Cryptix Legacy Account (KDX, cryptixnet.io Web Wallet)".to_string()
    }
