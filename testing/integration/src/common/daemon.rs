...
use cryptix_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use cryptix_utils::triggers::Listener;
use cryptixd_lib::{args::Args, daemon::create_core_with_runtime};
use parking_lot::RwLock;
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use cryptix_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_cryptix_tempdir();
